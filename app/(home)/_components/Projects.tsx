    ...
    <Section>
      <Container className="space-y-10">
        <div className="text-center space-y-3">
          <h2>Projects</h2>
          <p className="max-w-xl mx-auto text-sm text-muted-foreground sm:text-base md:text-lg">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {PROJECTS.map((project, index) => (
            <article
              ...
              className="flex flex-col rounded-2xl border border-slate-200 bg-card p-5 shadow-[0_18px_40px_rgba(15,23,42,0.08)] transition hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(15,23,42,0.16)] dark:border-slate-700 dark:bg-slate-900/40"
            >
